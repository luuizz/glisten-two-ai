...
export default function AnimateContent({ slice }: {slice:Content.HeroSlice}) {
  ...
  return (
        ...
        {isFilled.richText(slice.primary.body) && (
          <div className="hero__body mx-auto mt-6 max-w-md text-balance text-slate-300 text-center opacity-0">
