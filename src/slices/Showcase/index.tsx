...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="grid mt-16 items-center rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-7 py-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12 gap-8 lg:gap-0">
        <div>
        ...
        <PrismicNextImage className={clsx("opacity-90 shadow-2xl lg:col-span-2 lg:pt-0",
        slice.variation === "reverse" ? "lg:order-1 lg:translate-x-[15%]" :
        "lg:-order-1 lg:translate-x-[-15%]")} field={slice.primary.image} />
      </div>
    </Bounded>
  );
};
