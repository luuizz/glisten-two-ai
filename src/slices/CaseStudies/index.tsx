    ...
    >
      ...
      <div className="mt-20 grid gap-16">
        {caseStudies.map((caseStudy, index) => (
          caseStudy && (
            <div key={caseStudy.id} className="relative grid gap-4 opacity-85 transition-opacity duration-300 hover:cursor-pointer hover:opacity-100 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex col-span-1 flex-col justify-center gap-4">
                ...
                <PrismicNextLink document={caseStudy} className="after:absolute after:inset-0 hover:underline">
                  Saiba mais sobre o estudo de caso <PrismicText field={caseStudy.data.company} />.
                </PrismicNextLink>
              </div>
